...
* Fieldtrip Toolbox for MEG data analysis
* Custom MATLAB code for the calculation of Phase Amplitude Coupling (PAC)
* Psychopy for programming psychology experiments
* Eprime for programming psychology experiments
* Scientific Python for psychology/behavioural data analysis
